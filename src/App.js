...
<div class="col-md-3" style={{position: "relative", overflow: "hidden"}}>
      <div class="tile ingredient tiles-item" style={{display: "block", left: "0px", top: "0px", transform: "translate3d(0px, 0px, 0px)"}}> <span class="check-box">
        <input  type="checkbox" class="ingredient-check"/>
        <span class="ingredient-checkbox"></span> <span class="ingredient-checkbox-label">Buttons&nbsp;</span> <span class="clear"></span> </span> </div>
	  <br/>
      <div class="tile ingredient tiles-item" style={{display: "block", left: "0px", top: "0px", transform: "translate3d(0px, 0px, 0px)"}}> <span class="check-box">
        <input  type="checkbox" class="ingredient-check"/>
        <span class="ingredient-checkbox"></span> <span class="ingredient-checkbox-label">Cardboard&nbsp;</span> <span class="clear"></span> </span> </div>
	  <br/>
      <div class="tile ingredient tiles-item" style={{display: "block", left: "0px", top: "0px", transform: "translate3d(0px, 0px, 0px)"}}> <span class="check-box">
        <input  type="checkbox" class="ingredient-check"/>
        <span class="ingredient-checkbox"></span> <span class="ingredient-checkbox-label">Construction Paper&nbsp;</span> <span class="clear"></span> </span> </div>
	  <br/>
      <div class="tile ingredient tiles-item" style={{display: "block", left: "0px", top: "0px", transform: "translate3d(0px, 0px, 0px)"}}> <span class="check-box">
        <input  type="checkbox" class="ingredient-check"/>
        <span class="ingredient-checkbox"></span> <span class="ingredient-checkbox-label">Crayons&nbsp;</span> <span class="clear"></span> </span> </div>
	  <br/>
      <div class="tile ingredient tiles-item" style={{display: "block", left: "0px", top: "0px", transform: "translate3d(0px, 0px, 0px)"}}> <span class="check-box">
        <input  type="checkbox" class="ingredient-check"/>
        <span class="ingredient-checkbox"></span> <span class="ingredient-checkbox-label">Paint&nbsp;</span> <span class="clear"></span> </span> </div>
	  <br/>
      <div class="tile ingredient tiles-item" style={{display: "block", left: "0px", top: "0px", transform: "translate3d(0px, 0px, 0px)"}}> <span class="check-box">
        <input  type="checkbox" class="ingredient-check"/>
        <span class="ingredient-checkbox"></span> <span class="ingredient-checkbox-label">Plastic Bag&nbsp;</span> <span class="clear"></span> </span> </div>
    </div>
    <div class="col-md-3" style={{position: "relative", overflow: "hidden"}}>
      <div class="tile ingredient tiles-item" style={{display: "block", left: "0px", top: "0px", transform: "translate3d(0px, 0px, 0px)"}}> <span class="check-box">
        <input  type="checkbox" class="ingredient-check"/>
        <span class="ingredient-checkbox"></span> <span class="ingredient-checkbox-label">Plastic Bottle&nbsp;</span> <span class="clear"></span> </span> </div>
	  <br/>
      <div class="tile ingredient tiles-item" style={{display: "block", left: "0px", top: "0px", transform: "translate3d(0px, 0px, 0px)"}}> <span class="check-box">
        <input  type="checkbox" class="ingredient-check"/>
        <span class="ingredient-checkbox"></span> <span class="ingredient-checkbox-label">Plastic Can&nbsp;</span> <span class="clear"></span> </span> </div>
	  <br/>
      <div class="tile ingredient tiles-item" style={{display: "block", left: "0px", top: "0px", transform: "translate3d(0px, 0px, 0px)"}}> <span class="check-box">
        <input  type="checkbox" class="ingredient-check"/>
        <span class="ingredient-checkbox"></span> <span class="ingredient-checkbox-label">Plastic Cup&nbsp;</span> <span class="clear"></span> </span> </div>
	  <br/>
      <div class="tile ingredient tiles-item" style={{display: "block", left: "0px", top: "0px", transform: "translate3d(0px, 0px, 0px)"}}> <span class="check-box">
        <input  type="checkbox" class="ingredient-check"/>
        <span class="ingredient-checkbox"></span> <span class="ingredient-checkbox-label">Plastic Fork&nbsp;</span> <span class="clear"></span> </span> </div>
	  <br/>
      <div class="tile ingredient tiles-item" style={{display: "block", left: "0px", top: "0px", transform: "translate3d(0px, 0px, 0px)"}}> <span class="check-box">
        <input  type="checkbox" class="ingredient-check"/>
        <span class="ingredient-checkbox"></span> <span class="ingredient-checkbox-label">Plastic Jug&nbsp;</span> <span class="clear"></span> </span> </div>
	  <br/>
      <div class="tile ingredient tiles-item" style={{display: "block", left: "0px", top: "0px", transform: "translate3d(0px, 0px, 0px)"}}> <span class="check-box">
        <input  type="checkbox" class="ingredient-check"/>
        <span class="ingredient-checkbox"></span> <span class="ingredient-checkbox-label">Plastic Knife&nbsp;</span> <span class="clear"></span> </span> </div>
    </div>
    <div class="col-md-3" style={{position: "relative", overflow: "hidden"}}>
      <div class="tile ingredient tiles-item" style={{display: "block", left: "0px", top: "0px", transform: "translate3d(0px, 0px, 0px)"}}> <span class="check-box">
        <input  type="checkbox" class="ingredient-check"/>
        <span class="ingredient-checkbox"></span> <span class="ingredient-checkbox-label">Plastic Spoon&nbsp;</span> <span class="clear"></span> </span> </div>
	  <br/>
      <div class="tile ingredient tiles-item" style={{display: "block", left: "0px", top: "0px", transform: "translate3d(0px, 0px, 0px)"}}> <span class="check-box">
        <input  type="checkbox" class="ingredient-check"/>
        <span class="ingredient-checkbox"></span> <span class="ingredient-checkbox-label">Scissors&nbsp;</span> <span class="clear"></span> </span> </div>
	  <br/>
      <div class="tile ingredient tiles-item" style={{display: "block", left: "0px", top: "0px", transform: "translate3d(0px, 0px, 0px)"}}> <span class="check-box">
        <input  type="checkbox" class="ingredient-check"/>
        <span class="ingredient-checkbox"></span> <span class="ingredient-checkbox-label">Spray Paint&nbsp;</span> <span class="clear"></span> </span> </div>
	  <br/>
      <div class="tile ingredient tiles-item" style={{display: "block", left: "0px", top: "0px", transform: "translate3d(0px, 0px, 0px)"}}> <span class="check-box">
        <input  type="checkbox" class="ingredient-check"/>
        <span class="ingredient-checkbox"></span> <span class="ingredient-checkbox-label">Stickers&nbsp;</span> <span class="clear"></span> </span> </div>
	  <br/>
      <div class="tile ingredient tiles-item" style={{display: "block", left: "0px", top: "0px", transform: "translate3d(0px, 0px, 0px)"}}> <span class="check-box">
        <input  type="checkbox" class="ingredient-check"/>
        <span class="ingredient-checkbox"></span> <span class="ingredient-checkbox-label">String&nbsp;</span> <span class="clear"></span> </span> </div>
	  <br/>
      <div class="tile ingredient tiles-item" style={{display: "block", left: "0px", top: "0px", transform: "translate3d(0px, 0px, 0px)"}}> <span class="check-box">
        <input  type="checkbox" class="ingredient-check"/>
        <span class="ingredient-checkbox"></span> <span class="ingredient-checkbox-label">Twine&nbsp;</span> <span class="clear"></span> </span> </div>
    </div>
